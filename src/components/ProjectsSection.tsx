    ...
    <div className="mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.map((project) => {
          const isLiveMissing =
            !project.livelink || project.livelink.toLowerCase().includes("deploying soon");
            ...
            if (project.sourcelink) {
              actionButtons = (
                <a
                  ...
                  className="bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-400 text-center"
                >
                  🛠 Source
                </a>
              );
              ...
              actionButtons = (
                <span className="bg-gray-800 text-white px-4 py-2 hover:bg-gray-400 text-center cursor-not-allowed rounded-md">
                  ❌ No Source
                </span>
              );
            }
            ...
            actionButtons = (
              <>
                ...
                {project.sourcelink ? (
                  ...
                  <span className="bg-gray-800 text-white px-4 py-2 hover:bg-gray-400 flex-1 text-center cursor-not-allowed rounded-md">
                    ❌ No Source
                  </span>
                )}
              </>
          ...
          return (
            ...
            >
              ...
              <div className={`flex gap-4 mt-4 ${isLiveMissing ? "justify-center" : ""}`}>
                {actionButtons}
              </div>
            </div>
          );
